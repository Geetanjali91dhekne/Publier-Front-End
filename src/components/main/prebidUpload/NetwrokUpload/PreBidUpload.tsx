            ...
            <div className="flex justify-between">
                <div className="flex justify-between items-center gap-5">
                    ...
                    <div className="">
                        ...
                        <div className="absolute">{validateCsv && (selectValue === '' || Date === '') && <span className="common_error ml-1">Please Select Date and Netwrok</span>}</div>
                    </div>
                    ...
                    <div className="">
                        <PButton
                            ...
                            onClick={() => {
                                // if (selectValue !== '' && Date !== '') {
                                if (selectValue == '201') {
                                    console.log('https://localhost/HRE/app/crons/cron_connatix.php?Date=' + Date);
                    ...
                    <div>
                        <div className="flex justify-between">
                            <div className="w-[190px]">
                                <CommonDropDown title={'Enter Site Alias'} dataList={prebidSiteData} setValue={(val: any) => setNewRowData({ ...newRowData, siteAlias: val })} loader={prebidSizeAndSizeLoader} value={newRowData?.siteAlias} />
                            </div>

                            <div className="w-[190px]">
                                <CommonDropDown title={'Enter Size Alias'} dataList={prebidSizeData} setValue={(val: any) => setNewRowData({ ...newRowData, sizeAlias: val })} loader={prebidSizeAndSizeLoader} value={newRowData?.sizeAlias} />
                            </div>
                        </div>
