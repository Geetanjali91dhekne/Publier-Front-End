const PrebidDashboardTypes = {
    ...
    FETCH_PREBID_SITE_LIST: 'FETCH_PREBID_SITE_LIST',
    SET_PREBID_SITE_LIST: 'SET_PREBID_SITE_LIST',
...
export interface PrebidSitelist {
    site_name: string;
    id: string;
...
export interface PrebidDashboardState {
    ...
    prebidSitelist: PrebidSitelist[];
    prebidSitelistlLoading: boolean;
