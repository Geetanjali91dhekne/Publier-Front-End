...
const CountryTableCrowdFunding: React.FC<Props> = ({ comparison }) => {
    const data = useSelector((state: RootState) => state.crowdFundDashboard.crowdFundingCountryTable);
    const loader = useSelector((state: RootState) => state.crowdFundDashboard.crowdFundingCountryTableLoader);
    const columns = [
        {
            dataIndex: 'countries',
            title: 'Countries',
            fixed: 'left',
            sorter: (a: any, b: any) => String(a.countries).localeCompare(String(b.countries)),
        },
        {
            dataIndex: 'pageviews',
            title: 'Page Views',
...
export default CountryTableCrowdFunding;
