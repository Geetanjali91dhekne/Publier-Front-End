...
import CrowdFundingCharts from '../dashboard/CrowdFundingCharts';
import CrowdFundingTables from '../dashboard/CrowdFundingTables';
import StatsCrowdFunding from '../dashboard/StatsCrowdFunding';
import CrowdFundingTopCards from '../dashboard/topCardsCrowdFunding';
import WidgetCrowdFunding from '../dashboard/Widgets';
export const API_date_format = 'YYYY/MM/DD';

const CrowdFundingDetails: React.FC = () => {
    ...
    const onClickBack = () => {
        navigate(`${HEADERMENU_PATH.dashboard}${HEADERMENU_PATH.crowdFunding}`);
    };
    return (
        <div className="mt-4">
            <div className="flex flex-row flex-wrap mx-2 justify-start items-center">
                <div className="w-3/4">
                    <Select
                        ...
                        onChange={(e) => {
                            navigate(`${HEADERMENU_PATH.dashboard}${HEADERMENU_PATH.crowdFunding}/${e}`);
                        }}
                        className="w-full"
                        showSearch
            ...
            <div className="dashboard">
                ...
                <WidgetCrowdFunding startDate={startDate} endDate={endDate} revenueType={revenueType} siteId={siteId} />
                <StatsCrowdFunding startDate={startDate} endDate={endDate} revenueType={revenueType} siteId={siteId} />

                <CrowdFundingTables startDate={startDate} endDate={endDate} revenueType={revenueType} compare={compare} compare_start_date={dstring2.sdate} compare_end_date={dstring2.edate} comparison={compaison} siteId={siteId} />
                <CrowdFundingCharts
                    startDate={startDate}
                    endDate={endDate}
                    revenueType={revenueType}
