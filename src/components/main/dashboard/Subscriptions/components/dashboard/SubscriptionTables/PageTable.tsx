...
const PageTable: React.FC<Props> = ({ compare }) => {
    const data = useSelector((state: RootState) => state.subsDashboard.pageTable);
    const loading = useSelector((state: RootState) => state.subsDashboard.pageTableLoader);
