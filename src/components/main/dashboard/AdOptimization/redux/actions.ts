...
// For Demand Partners
function fetchSitesTableByNetwork(data: Object, networkid: any): CommonAction {
    return {
        type: AdOptDashboardTypes.FETCH_SITES_LIST_AD_OPT_SITES_BY_NETWORK,
        payload: { apiPayload: data, networkid: networkid },
    };
}
function setSitesTableByNetwork(data?: Object): CommonAction {
    return {
        type: AdOptDashboardTypes.SET_SITES_LIST_AD_OPT_SITES_BY_NETWORK,
        payload: data,
    };
}
