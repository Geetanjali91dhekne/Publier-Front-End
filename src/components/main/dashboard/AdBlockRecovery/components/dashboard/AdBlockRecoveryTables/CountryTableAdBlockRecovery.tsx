...
const CountryTableAdBlockRecovery: React.FC<Props> = ({ comparison }) => {
    const data = useSelector((state: RootState) => state.adBlockDashboard.adBlockCountryTable);
    const loader = useSelector((state: RootState) => state.adBlockDashboard.adBlockCountryTableLoader);
    const columns = [
        {
            dataIndex: 'country',
            title: 'Country',
...
export default CountryTableAdBlockRecovery;
