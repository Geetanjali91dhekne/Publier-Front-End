...
// For Demand Partners Inner Table
const fetchSitesTableByNetwork = (payload: Object, networkid: string) => api.post(`/api/optimization/demand/all/sites`, payload);
const fetchSitesByNewtorkExportTable = (payload: Object) => api.post(`/api/optimization/demand/all/sites/export`, payload);
//Crowdfunding apis
...
const prebidRunApi = (payload: Object) => api.post(`/api/prebid/runapi`, payload);
...
// console.log(fetchNetworkSettingAllSites);
...
const fetchallSiteListUploadApi = () => api.get(`/api/onboarding/adoptimization/siteslist`);
...
const Apis = {
    ...
    // For Demand Partner
    fetchSitesTableByNetwork,
    fetchSitesByNewtorkExportTable,
};
